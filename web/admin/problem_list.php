...
//echo $sql;
if($keyword) $sql="select `problem_id`,`title`,`in_date`,`defunct` FROM `problem` where title like '%$keyword%' or source like '%$keyword%' or problem_id like '%$keyword%'";
$result=mysql_query($sql) or die(mysql_error());
?>
<form action=problem_list.php><input placeholder='title or source or pid' name=keyword><input type=submit value="<?php echo $MSG_SEARCH?>" ></form>
