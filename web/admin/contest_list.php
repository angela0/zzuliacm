...
if($keyword) 
	$sql="select `contest_id`,`title`,`start_time`,`end_time`,`private`,`defunct` FROM `contest` where title like '%$keyword%' or contest_id like '%$keyword%'";
$result=mysql_query($sql) or die(mysql_error());
?>
<form action=contest_list.php class=center><input placeholder='ContestID or Title' name=keyword><input type=submit value="<?php echo $MSG_SEARCH?>" ></form>
