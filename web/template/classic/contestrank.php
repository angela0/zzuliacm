...
$rank=1;
?>
<?php require('contest-header.php');?>
<table id=rank width=90% style='margin-left: auto; margin-right:auto'>
	<tr class=toprow align=center><td width=5%>Rank</td><td width=10%>User</td><td width=10%>Nick</td><td width=5%>Solved</td><td width=5%>Penalty</td>
<?php
for ($i=0;$i<$pid_cnt;$i++)
